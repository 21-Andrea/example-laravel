...
const Genera_informe_Resp = () => {
    ...
    const getAllEncuestado = async () => {
        const response = await axios.get(`${endpoint}/${encuestado.cedula_U}`);
        const userData = response.data;
        setEncuestado([userData]);
    };
                const getAllusuario = async () => {
                    const response_U = await axios.get(`${endpoint_2}`);
                ...
                const getAllrespuestas = async () => {
                    ...
                    const response_R = await axios.get(`${endpoint_3}`);
                ...
                <View style={styles.body}>
                    ...
                    <View>
                        <table style={styles_T.table}>
                            ...
                            {usuario.map((us,enc,pre,resp) => (
                                <tr style={styles_T.tableRow}>
                                    <td style={styles_T.tableCell}>
                                        <Text>{us.cedula}</Text>
                                    </td>
                                    <td style={styles_T.tableCell}>
                                        <Text>{preguntas_P[pre].Preguntas}</Text>
                                    </td>
                                    <td style={styles_T.tableCell}>
                                        <Text>{respuestas_R[resp].Respuesta}</Text>
                                    </td>
...
export default Genera_informe_Resp;
