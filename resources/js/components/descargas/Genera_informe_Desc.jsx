...
const endpoint = 'http://localhost:8000/api/preguntas'; // preguntas
                ...
                <View style={styles.body}>
                    ...
                    <View>
                        <table style={styles_T.table}>
                            ...
                            {preguntas_P.map((prg) => (
                                <tr style={styles_T.tableRow} key={prg.id}>
                                    ...
                                    <td style={styles_T.tableCell}>
                                        <Text>{prg.Categoria}</Text>
                                    </td>
                                    <td style={styles_T.tableCell}>
                                        <Text>{formatDate(prg.created_at)}</Text>
                                    </td>
                                </tr>
                            ))}
                        </table>
...
export default Genera_informe_Desc;
