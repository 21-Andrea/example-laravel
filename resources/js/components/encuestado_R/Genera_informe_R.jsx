                ...
                <View style={styles.body}>
                    ...
                    <View>
                        <table style={styles_T.table}>
                            ...
                            {encuestado.map((enc) => (
                                <tr style={styles_T.tableRow} key={enc.id}>
                                    <td style={styles_T.tableCell}>
                                        <Text>{enc.Empresa}</Text>
                                    </td>

                                    <td style={styles_T.tableCell}>
                                        <Text>{enc.Celular}</Text>
                                    </td>
                                    <td style={styles_T.tableCell}>
                                        <Text>{enc.Correo}</Text>
                                    </td>
                                    <td style={styles_T.tableCell}>
                                        <Text>{enc.cedula_U}</Text>
                                    </td>
                                    <td style={styles_T.tableCell}>
                                        <Text>{formatDate(enc.created_at)}</Text>
                                    </td>
                                </tr>
                            ))}
                        </table>
...
export default Genera_informe_R;
